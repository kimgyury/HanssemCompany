...
var tmsts=0;
	...
	window.addEventListener("load",function(){
		...
		$(window).scroll(function(){
			...
			/// 1번 페이지 액션
			if(currBar>600 && currBar<900){
				
				$("#bg1").stop().animate({opacity:1,bottom:"0%"},700,"easeOutSine");
				$("#bg2").stop().animate({opacity:1,bottom:"0%"},700,"easeOutSine");
			}
			else if(currBar>200 && currBar<300){
				$(".pic1_2").stop().animate({opacity:1,bottom:"0%"},700,"easeOutSine");
				$("#baro1").stop().animate({opacity:1,bottom:"0%"},700,"easeOutSine");
				$("#baro2").stop().animate({opacity:1,bottom:"0%"},700,"easeOutSine");
			...
			else if(currBar>500 && currBar<700){
				
				$(".baro3").stop().animate({opacity:1,bottom:"0%"},700,"easeOutSine");
				$(".icon").stop().animate({opacity:1,bottom:"0%"},2000,"easeOutSine");
			}
	...
	$(function(){//// jQB ////
		...
		function initSet(){
			$("#bg1").css({opacity:0,bottom:"-50%"});
			$("#bg2").css({opacity:0,bottom:"-50%"});
			$(".pic1_2").css({opacity:0,bottom:"-50%"});
			$("#baro1").css({opacity:0,bottom:"-50%"});
			$("#baro2").css({opacity:0,bottom:"-50%"});
			$(".baro3").css({opacity:0,bottom:"-50%"});
			$(".icon").css({opacity:0,bottom:"-50%"});
